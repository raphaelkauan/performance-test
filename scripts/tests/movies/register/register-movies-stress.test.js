...
export function handleSummary(data) {
    return {
        'register-movies-stress.test.html': htmlReport(data),
    };
}
...
export const options = environment.options.stresses.stressRegisterMovies;
...
export default function () {
    ...
    checks.checkTime('Check time register movies', res, 250);
